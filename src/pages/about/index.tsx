    ...
    <div className="container mx-auto py-16 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-8">
            <div className="max-w-lg">
                <h2 className="text-3xl font-extrabold text-white-900 sm:text-4xl">{data?.title}</h2>
                <p className="mt-4 text-white-600 text-lg" dangerouslySetInnerHTML={{__html: data?.description}}></p>
                <div className="mt-8">
